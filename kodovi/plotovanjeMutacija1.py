...
def svesve():
    ...
    m=mutacije
    g=greske
    workbook = xlsxwriter.Workbook("mutacije harmony rekomb 0.05" +".xlsx")
    ...
    workbook.close()
    workbook = xlsxwriter.Workbook("greske harmony rekomb 0.05"+".xlsx")
    worksheet = workbook.add_worksheet()
    row = 0

    for col, data in enumerate(g):
        worksheet.write_column(row, col, data)

    workbook.close()
#    if matricaNova[19][brojGeneracija-1][0]>1:
#        plt.plot(koeficijentMutacije,column(m,[0]))
#        plt.errorbar(koeficijentMutacije,column(m,[0]),column(g,[0]),label='uvek izdaj', color="blue")
#    if matricaNova[19][brojGeneracija-1][15]>1:
#        plt.plot(koeficijentMutacije,column(m,[15]))
#        plt.errorbar(koeficijentMutacije,column(m,[15]),column(g,[15]), label='grupa1', color="red")
##    if matricaNova[19][brojGeneracija-1][16]>1:
##        plt.plot(koeficijentMutacije,column(m,[16]))    
##        plt.errorbar(koeficijentMutacije,column(m,[16]),column(g,[16]),label='grupa2', color="green")
##    if matricaNova[19][brojGeneracija-1][20]>1:
##        plt.plot(koeficijentMutacije,column(m,[20]))
##        plt.errorbar(koeficijentMutacije,column(m,[20]),column(g,[20]), label='grupa3', color="green")
##    if matricaNova[19][brojGeneracija-1][21]>1:
##        plt.plot(koeficijentMutacije,column(m,[21]))    
##        plt.errorbar(koeficijentMutacije,column(m,[21]),column(g,[21]), label='TFT', color="gold")
#    if matricaNova[19][brojGeneracija-1][24]>1:
#        plt.plot(koeficijentMutacije,column(m,[24]))
#        plt.errorbar(koeficijentMutacije,column(m,[24]),column(m,[24]), label='grupa5', color="pink")
##    if matricaNova[19][brojGeneracija-1][25]>1:
##        plt.plot(koeficijentMutacije,column(m,[25]))
##        plt.errorbar(koeficijentMutacije,column(m,[25]),column(g,[25]), label='Pavlov', color="cyan")
##    if matricaNova[19][brojGeneracija-1][33]>1:
##        plt.plot(koeficijentMutacije,column(m,[33]))
##        plt.errorbar(koeficijentMutacije,column(m,[33]),column(g,[33]), label='GTFT', color="green")
##    if matricaNova[19][brojGeneracija-1][36]>1:        
##        plt.plot(koeficijentMutacije,column(m,[36]))
##        plt.errorbar(koeficijentMutacije,column(m,[36]),column(g,[36]), label='Pavlov k', color='purple')
#    if matricaNova[19][brojGeneracija-1][41]>1:
#        plt.plot(koeficijentMutacije,column(m,[41]))
#        plt.errorbar(koeficijentMutacije,column(m,[41]),column(g,[41]),label='TFT k',color="greenyellow")
##    if matricaNova[19][brojGeneracija-1][42]>1:
##        plt.plot(koeficijentMutacije,column(m,[42]))
##        plt.errorbar(koeficijentMutacije,column(m,[42]),column(g,[42]), label='grupa5', color="chocolate")
##    if matricaNova[19][brojGeneracija-1][48]>1:        
##        plt.plot(koeficijentMutacije,column(m,[48]))
##        plt.errorbar(koeficijentMutacije,column(m,[48]),column(g,[48]),label='flip flop', color="k")
#    if matricaNova[19][brojGeneracija-1][50]>1:
#        plt.plot(koeficijentMutacije,column(m,[50]))
#        plt.errorbar(koeficijentMutacije,column(m,[50]),column(g,[50]),label='flip flop k', color="y")
#    if matricaNova[19][brojGeneracija-1][52]>=0:        
#        plt.plot(koeficijentMutacije,column(m,[52]))    
#        plt.errorbar(koeficijentMutacije,column(m,[52]),column(g,[52]),label='GTFT k', color='salmon')
##    if matricaNova[19][brojGeneracija-1][58]>1:
##        plt.plot(koeficijentMutacije,column(m,[58]))
##        plt.errorbar(koeficijentMutacije,column(m,[58]),column(g,[58]),label='grupa1 k', color='salmon')
##    if matricaNova[19][brojGeneracija-1][59]>1:
##        plt.plot(koeficijentMutacije,column(m,[59]))
##        plt.errorbar(koeficijentMutacije,column(m,[59]),column(g,[59]),label='grupa3 k', color='plum')
#    if matricaNova[19][brojGeneracija-1][63]>1:
#        i=plt.plot(koeficijentMutacije,column(m,[63]))    
#        plt.errorbar(koeficijentMutacije,column(m,[63]),column(g,[63]),label='uvek saradjuj', color="navy")
#
#    plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
#    plt.ylabel('zastupljenost jedinke [%]')
...
#    putanja=(r'C:\Users\nina\Desktop\Grafici\Zatvorenikova dilema\mut.eps')
#    plt.savefig(putanja)
#    plt.show()
#
